...
if (isset($_POST['memberAge']))
{
	...
	$fields = array(
			...
			"memberScoreHistory" => "m_field_id_34"
			);
	...
	$score_history = '{exp:user:stats dynamic="off"}{memberScoreHistory}{/exp:user:stats}';
	if ($score_history) {
	...
	$dbvalues["m_field_id_34"] = serialize( $previousResults ); // Add calculated result to history
			...
			<form id="calculator" method="post" action="/my_health/{if logged_in}calculator{if:else}results{/if}">
				...
				<div class="grid12-23 clearfix">
					...
					<div class="right">
						...
						<ul>
							<li><label><input type="radio" name="memberDiet" class="memberDiet" value="11" onclick="healthcalc(this.form)" /> <span>Almost Every Day</span></label></li>
							<li><label><input type="radio" name="memberDiet" class="memberDiet" value="9" onclick="healthcalc(this.form)" /> <span>Sometimes</span></label></li>
							<li><label><input type="radio" name="memberDiet" class="memberDiet" value="5" onclick="healthcalc(this.form)" /> <span>Rarely or never</span></label></li>
						</ul>
					
						<h2>Nutrition</h2>
						<p>How often do you eat foods containing refined sugar or oil?</p>
						<ul>
							<li><label><input type="radio" name="memberNutrition" class="memberNutrition" value="6" onclick="healthcalc(this.form)" /> <span>Almost every day</span></label></li>
							<li><label><input type="radio" name="memberNutrition" class="memberNutrition" value="8" onclick="healthcalc(this.form)" /> <span>Once in a while</span></label></li>
							<li><label><input type="radio" name="memberNutrition" class="memberNutrition" value="10" onclick="healthcalc(this.form)" /> <span>Rarely or never</span></label></li>
						</ul>
