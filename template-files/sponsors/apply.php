...
<div class="grid23 clearfix">
	<div class="main left">
		<div class="post">
			<p>Please complete the following information for the sponsoring organization and the contact person who will serve as the local event coordinator. Once approved, a page will be created under the <a href="http://www.newstartclub.com/locations/">Locations</a> section of the NEWSTART&reg; Lifestyle Club website.</p>
		</div>
...
function getZIP (form) {
	...
	<table>
		...
		<tr>
			...
			<td><input type="text" class="input" name="contactName" id="contactName" value="{member_first_name} {member_last_name}" size="25" autocomplete="off" /></td>
		</tr>
		<tr>
			<th scope="row"><label for="contactAddress"><span class="req">* </span>Mailing Address</label></th>
			<td><input type="text" class="input" id="contactAddress" name="contactAddress" value="{member_address}" size="32" autocomplete="off" /></td>
		</tr>
		<tr>
			<th scope="row"><label for="contactCity"><span class="req">* </span>City</label></th>
			<td><input type="text" class="input" id="contactCity" name="contactCity" value="{member_city}" autocomplete="off" /></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td><input type="text" class="input" id="contactZipCode" name="contactZipCode" value="{member_zip}" size="7" autocomplete="off" /></td>
		</tr>
		<tr>
			<th scope="row"><label for="contactPhone"><span class="req">* </span>Phone</label></th>
			<td><input type="tel" class="input" id="contactPhone" name="contactPhone" value="{member_phone}" size="15" autocomplete="off" /></td>
		</tr>
		<tr>
			...
			<td>
				...
				<input type="hidden" class="hidden" id="applicantName" name="applicantName" value="{member_first_name} {member_last_name}" size="32" />
				<input type="hidden" class="hidden" id="applicantUsername" name="applicantUsername" value="{username}" size="32" />
			</td>
		</tr>
		{/exp:user:stats}
		<tr>
