...
{/exp:weblog:entry_form}
  ...
  <div class="right sidebar">
    <div class="bar">Add Events</div>
      ...
      <p><strong>IMPORTANT</strong>: Only approved {site_name} events may be added. If your event type is not listed <a href="http://www.newstartclub.com/sponsors/resources/">here</a>, please email <a href="mailto:club@newstart.com">club@newstart.com</a> or call 530-422-7993 before adding your event.</p>
  </div>
  </div><!-- /.grid23 -->