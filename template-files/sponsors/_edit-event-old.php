	...
	<div class="grid23 clearafter">
		<div class="left list">
		<form method="post" action="/sponsors/events/edit/" class="hide">
		...
		<ul>
			...
			{if no_results}<p>You don&rsquo;t have any current events. Click <a href="/sponsors/events/add/">here</a> to add a new event.</p>{/if}
				<li class="row">
		...
		<div class="right sidebar">
			...
			<p>To add a new event, click <a href="/sponsors/events/add/">here</a>.</p>
			<p>Click {exp:weblog:categories show="{embed:sponsor_number}" weblog="locations" style="linear"}<a href="{path='events/{category_url_title}'}">here</a>{/exp:weblog:categories} to see your active events.</p>
	</div>
	</div><!-- /.grid23 -->