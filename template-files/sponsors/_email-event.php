...
function show_form($listTotal)
{
	...
	<header class="heading">
		<h1 class="post__title">{exp:channel:entries channel="events" entry_id="{segment_4}" limit="1" show_future_entries="yes" dynamic="no" status="open|closed"}{title}{/exp:channel:entries} (&nbsp;'. $listTotal .'&nbsp;)</h1>
	</header>
