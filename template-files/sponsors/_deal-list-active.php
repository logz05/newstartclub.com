{if segment_3 == "delete" && segment_4}
	{exp:delete:delete_entry 
		entry_id="{segment_4}" 
		error_no_permissions='<div class="alert-box error"><p>You&rsquo;re only allowed to delete deals you have created or edited.</p></div>' 
	...
	<li>
		...
		<div class="details">
			<dl>
				...
				<dt>Author</dt>
				<dd>
					<p>{exp:user:stats member_id="{author_id}"}{member_first_name} {member_last_name}{/exp:user:stats}</p>
				</dd>
			</dl>
		</div>
	</li>
