...
<div class="body">
  ...
  <div class="grid23 clearafter">
    ...
    <div class="right sidebar">
      ...
      <p>Click {exp:weblog:categories show="{sponsor_number}" weblog="locations" style="linear"}<a href="/events/{category_url_title}">here</a>{/exp:weblog:categories} to see your active events.</p>
    </div>
    {/exp:user:stats}
  </div><!-- /.grid23 -->
  </div><!-- /.body -->
