							...
							<tr>
								...
								<td width="550" valign="middle" height="60" align="right" bgcolor="#000000" style="background-image: url(http://newstartclub.com/assets/images/email/newsletter/nav-texture.png); background-color:#000000">
									<div style="font-family:'Helvetica Neue', Arial, Helvetica, sans-serif; font-size:30px; color:#ffffff; padding: 12px 30px;">
										<span style="font-size:30px;color:#FFFFFF;font-family:'Helvetica Neue', Arial, Helvetica, sans-serif;">you&rsquo;re</span> <span style="font-size:30px;color:#FFFFFF;font-family:'Helvetica Neue', Arial, Helvetica, sans-serif;font-weight:bold;">Invited</span>
									</div>
								</td>
									...
									<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" style="margin:0">
										...
										<tr>
											<td style="font-family:'Helvetica Neue', Arial, Helvetica, sans-serif; font-weight: normal; line-height: 1.5; font-size:16px; color:#010101;">
												<p style="color:#010101;">Hi {message},</p>
												<p style="color:#010101;">You&rsquo;re invited to become a member of the <a href="http://newstartclub.com/" style="color:#87A621;">NEWSTART&reg; Lifestyle Club</a>&mdash;the most natural way to live longer, be energized, lose weight, increase strength, and get healthy. You&rsquo;ll find:</p>
												<ul>
													<li style="color:#010101;">Live streaming videos</li>
													<li style="color:#010101;">Local seminars &amp; events</li>
													<li style="color:#010101;">Expert health advice</li>
													<li style="color:#010101;">Wellness tips &amp; tools</li>
													<li style="color:#010101;">FREE membership</li>
												</ul>
												<p style="color:#010101;"><span style="color:#010101;">To join, simply click the link below:</span><br/><a href="http://newstartclub.com/register/key/{key}/{selected_group_id}" style="color:#87A621;">http://newstartclub.com/register/key/{key}/{selected_group_id}</a></p>
												<p style="color:#010101;">Enjoy,<br />The NEWSTART Lifestyle Club Team<br /><a href="http://newstartclub.com" style="color:#87A621;">newstartclub.com</a></p>
											</td>
										</tr>
										<tr>
											<td height="10"></td>
			...
			<table width="550" border="0" cellspacing="0" cellpadding="0" align="center" style="margin:0 auto">
				<tr>
					<td style="padding:15px 20px 0 20px; font-family: 'Lucida Grande', 'Lucida Sans Unicode', Verdana, sans-serif !important; font-size:10px; line-height: 1.34em; color:#204C74" align="center">
						A FREE community service sponsored by <a href="http://newstartclub.com/location/{selected_group_id}" style="font-size:10px;color:#204C74;font-family:verdana;text-decoration:underline;">{from_name}</a>.
					</td>
				</tr>
			</table>
