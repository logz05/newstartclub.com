...
<body class="small">
	<div class="body">
		...
		{if:elseif segment_2 == "detail" && segment_3 }
		
			<h1>Oops!</h1>
			<p>We couldn&rsquo;t find that entry in our {exp:stringy:upperfirst}{segment_1}{/exp:stringy:upperfirst}! <a href="{path='{segment_1}'}">View all {segment_1}</a>.</p>
