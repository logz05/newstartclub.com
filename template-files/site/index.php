	...
	<div class="grid23 clearafter">
		<div class="left">
			...
			<ul class="news_listing">
				{exp:weblog:entries weblog="resources|events|partners|sponsors|questions" limit="5" orderby="date" sort="desc" dynamic="off"}
		...
		{if member_group == "1" || member_group == "13"}
			<div class="sponsor-panel">
				<div id="sponsor-admin" class="bar"><a href="/sponsor_admin/">Sponsor Admin</a></div>
					<ul>
						<li><a href="/sponsor_admin/events/add/">&raquo; Add Event</a></li>
						<li><a href="/sponsor_admin/events/edit/">&raquo; Edit Event</a></li>
						<li><a href="/sponsor_admin/invite-members/">&raquo; Invite Members</a></li>
						<li><a href="/sponsor_admin/email-members/">&raquo; Email Members</a></li>
						<li><a href="/sponsor_admin/resources/">&raquo; Get Resources</a></li>
					</ul>
			</div>
		{/if}
		{if member_group == "1"}
		<div class="sponsor-panel">
			<div class="bar">Statistics</div>
			<ul>
				<li><a href="/super-admin/">&raquo; See site statistics</a></li>
			</ul>
		</div>
		{/if}
		</div><!--/.right-->
