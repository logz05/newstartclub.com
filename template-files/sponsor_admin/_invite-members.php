...
?>
	...
	<div class="grid23 clearafter">
		...
		{exp:user:key template="sponsor_admin/invite_template" html="yes" return="{embed:channel}/{segment_2}"}
		...
		<div class="sidebar right">
			...
			<p><a href="{path='members/register/{embed:sponsor_number}/'}">http://www.newstartclub.com/<br />members/register/{embed:sponsor_number}/</a></p>
