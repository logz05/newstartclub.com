...
<div class="grid23 clearfix">
	<div class="main left">
		<div class="post">
			...
			<hr>
			<h3>References</h3>
			<p class="footnote" id="fn1"><sup>1</sup> <a href="http://diabetes.webmd.com/news/20110902/improving-lifestyle-reduces-diabetes-risk" title="WebMD Health News">Improving Lifestyle Reduces Diabetes Risk</a></p>
			<p class="footnote" id="fn2"><sup>2</sup> <a href="http://www.annals.org/content/155/5/292.abstract" title="Sept. 6 Issue of Annals of Internal Medicine">Lifestyle Factors and Risk for New-Onset Diabetes—A Population-Based Cohort Study</a></p>
			<p class="footnote" id="fn3"><sup>3</sup> <a href="http://www.heartattackproof.com/resolving_cade.htm">Resolving the Coronary Artery Disease Epidemic through Plant-Based Nutrition</a></p>
		</div>
	</div>
