...
<body>
	...
	<div class="body  my-health">
		...
		<header class="heading">
			<h1 class="post__title" data-icon="c">How is Your Health?</h1>
		</header>
			...
			<div class="main  left">
				...
				<article class="post">
					...
					<figure class="figure  figure--main  left">
						<img src="{site_url}/assets/images/my-health/my-health-image.png">
					</figure>
					<strong>Making positive lifestyle choices could cut your risk for diabetes by about 80%.</strong><sup id="fnref:1"><a href="#fn:1" rel="footnote">1</a></sup>
					<p>Taking the right health risk assessment (HRA) is the first step to living well naturally. The NEWSTART&reg; Lifestyle Club <span class="caps">HRA</span> — HealthGauge&trade; Health Score Calculator—is based on a recent study<sup id="fnref:2"><a href="#fn:2" rel="footnote">2</a></sup> where the health practices of 200,000 people were recorded. When the participants were surveyed ten years later, the research revealed a clear relationship between five key health practices and one&rsquo;s risk for developing type 2 diabetes. Individuals who managed to make improvements in all five risk areas were able to reduce their risk by about 80%, according to the study.</p>
					...
					<p><strong>Key features of the HealthGauge&trade; Health Score Calculator:</strong></p>
					<ul>
						...
						<li>Access to the NEWSTART&reg; health information request portal</li>
					</ul>
