{exp:channel:entries channel="member-relations" dynamic="no" search:related_entry="{embed:entry_id}" search:relation_type="=deal" author_id="CURRENT_USER" disable="categories|category_fields|pagination"}
	{if no_results}
		{exp:safecracker channel="member-relations" return="{segment_1}/coupon/{segment_3}"}
	...
	<a href="{path='{segment_1}/coupon/{segment_3}'}" id="print-deal" class="super small secondary button print-coupon" target="_blank"><span>Print</span></a>
