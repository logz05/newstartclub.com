...
?>
  ...
  <link rel="stylesheet" href="/assets/css/nsc.css<?php fileModTime('/assets/css/nsc.css'); ?>" type="text/css" />
{if embed:add}
  <?php 
...
<body id="{embed:channel}" class="{if embed:header == 'no' && segment_1 != 'sponsors'}standalone {/if}{if logged_out || (member_group != 1 && member_group != 13)}logged-out{if:else}logged-in{/if}" {if (segment_1 =="locations" || segment_1 == "events") && segment_2 == "detail" && segment_3 != ""} onload="initialize()"{/if}>
  <div class="container">
    <header role="banner">
    {if embed:nav == ""}
      <nav id="super-nav">
