					...
					<table>
						...
						<tr>
							...
							<td>
								...
								<input type="text" class="input  hidden" id="ff_country" name="ff_country" value="" size="30" />
							</td>
						</tr>
						...
						<tr>
							...
							<td>
								...
								<div class="edit-address" id="edit-address">
									<input type="text" class="input  ff_city" id="ff_city" name="ff_city" value="" size="24" placeholder="City" />
									<input type="text" class="input  ff_state" id="ff_state" name="ff_state" value="" size="20" placeholder="State" />
...
jQuery(document).ready(function($){
	...
	$("#partner_register").slideDown('slow').css({opacity:0}).animate({"opacity": 1}, "slow");
...
function addressLookUp(form, resultHandler) {
	...
	var address = form.ff_address.value;
	var zipcode = form.ff_zip_code.value;
			...
			for (var component in result[0]['address_components']) {
				for (var i in result[0]['address_components'][component]['types']) {
					...
					if (result[0]['address_components'][component]['types'][i] == "postal_town") {
						...
						document.getElementById('ff_city').value = city;
						document.getElementById('results-city').innerHTML = city;
					}
					...
					if (result[0]['address_components'][component]['types'][i] == "administrative_area_level_1") {
						...
						document.getElementById('ff_state').value = state;
						document.getElementById('results-state').innerHTML = state;
					}
